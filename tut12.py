...
def getvals():
    ...
    print(f"{namevalue.get(), phonevalue.get(), gendervalue.get(), emergency_Contactvalue.get(), paymentvalue.get(), foodservicevalue.get()}")




    with open("records.txt","a") as f:
        f.write(f"{namevalue.get(), phonevalue.get(), gendervalue.get(), emergency_Contactvalue.get(), paymentvalue.get(), foodservicevalue.get()}\n")
